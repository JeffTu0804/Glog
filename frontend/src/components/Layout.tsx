    ...
    <NotificationProvider>
      <div className="min-h-screen bg-[var(--color-glog-bg)]">
        <header className="sticky top-0 z-40 border-b border-slate-200/60 bg-white/95 backdrop-blur-md">
          ...
          <nav className="mx-auto flex w-full max-w-[1400px] gap-1 overflow-x-auto border-t border-slate-100 px-4 py-2.5 sm:px-6 lg:hidden">
            {NAV_ITEMS.map((item) => (
              <NavLink
                key={item.to}
                to={item.to}
